		...
		<section className='landpage'>
			<div>
				...
				<p style={{ color: `${themeColorScheme.text}` }}>
					The coronavirus is spreading to fast and I want you to be aware of
				...
				<p style={{ color: `${themeColorScheme.text}` }}>
					...
					<a
						...
						target='blank'
						href='https://www.who.int/emergencies/diseases/novel-coronavirus-2019/question-and-answers-hub/q-a-detail/coronavirus-disease-covid-19-masks'>
						here
					</a>
					.
				</p>
